...
{
    static public bool mf;          //性別　true＝男性　false=女性
    ...
    static public bool marriage;    //結婚しているかどうか？　true＝結婚している　false=結婚してない
    ...
    {//はじめから開始時にすべての変数をリセットするメソッド
        ...
        marriage = false;    //生まれながら結婚している奴などいない！
